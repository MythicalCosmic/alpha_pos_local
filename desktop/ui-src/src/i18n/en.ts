...
const en = {
  ...
  "sync.live": "Sync live",
  "sync.off": "Sync off",
  "sync.offHint": "Cloud sync is switched off for this till. Turn it on in Settings.",
  "sync.pending": "queued",
  ...
  "upd.checkRequested": "Checking for a new version. It downloads in the background if there is one.",
  ...
  "upd.readyMsg": "Version {version} is downloaded and verified. It installs when you press “Restart to update” or the next time Alpha POS starts — never during service.",
  "upd.restartAsked": "Confirm the update in the Alpha POS window that just opened.",
