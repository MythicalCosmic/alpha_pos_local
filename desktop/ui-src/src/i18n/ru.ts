...
const ru: Record<keyof typeof en, string> = {
  ...
  "sync.off": "Синхр. выкл",
  "sync.offHint": "Облачная синхронизация выключена для этой кассы. Включите её в настройках.",
  ...
  "upd.checkRequested": "Проверяем наличие новой версии. Если она есть, загрузка пойдёт в фоне.",
  "upd.checking": "Проверка…",
  "upd.current": "Эта установка",
  "upd.dev": "Запуск из исходников",
  "upd.disabledMode": "Обновления отключены",
  "upd.ready": "Обновление готово",
  "upd.readyMsg": "Версия {version} загружена и проверена. Она установится по кнопке «Перезапустить для обновления» или при следующем запуске Alpha POS — не во время работы.",
  "upd.restartAsked": "Подтвердите обновление в открывшемся окне Alpha POS.",
