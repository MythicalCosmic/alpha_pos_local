...
const uz: Record<keyof typeof en, string> = {
  ...
  "upd.checkRequested": "Yangi versiya tekshirilmoqda. Agar bo‘lsa, u fonda yuklab olinadi.",
  ...
  "upd.ready": "Yangilanish tayyor",
  "upd.readyMsg": "{version} versiyasi yuklab olindi va tekshirildi. U «Yangilash uchun qayta ishga tushirish» tugmasi bosilganda yoki Alpha POS keyingi safar ishga tushganda o‘rnatiladi — ish vaqtida emas.",
  "upd.restartAsked": "Ochilgan Alpha POS oynasida yangilanishni tasdiqlang.",
  ...
  "upd.restart": "Yangilash uchun qayta ishga tushirish",
  "upd.restartFailed": "Yangilash uchun qayta ishga tushirib bo‘lmadi",
